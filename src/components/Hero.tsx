  ...
  return (
    <>
      {/* =====================================================
          ...
          Stays fixed while the entire page scrolls
      ====================================================== */}
      <div className="fixed inset-0 -z-10 overflow-hidden">
        ...
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[650px] h-[350px] bg-gradient-to-tr from-[#0050FF]/15 via-[#00D6FF]/10 to-transparent rounded-full blur-[120px]" />
      ...
      {/* =====================================================
          HERO CONTENT
      ====================================================== */}
      <section className="relative min-h-[90vh] pt-32 pb-20 px-6 overflow-hidden flex flex-col items-center justify-center">
        ...
        <div className="max-w-4xl mx-auto w-full text-center relative z-10">
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/[0.04] border border-white/[0.08] text-xs font-medium text-white/70 mb-6 backdrop-blur-md animate-fade-in">
            ...
            <span>
              No accounts • 24-hour self-destruction • Zero logs
            </span>
          </div>
        </div>
      </section>
